...
export default function Certificates() {
  ...
  // Upload gambar ke Supabase Storage dan simpan URL ke tabel certificates
  const uploadImage = async () => {
    ...
    try {
      ...
      // 3. Simpan URL ke tabel certificates
      const { error: insertError } = await supabase
        .from('certificates')
        .insert([
          {
            img: publicUrl, // pastikan nama kolom di database adalah "img"
          },
        ])
